...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void setupNavigation() {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_parentContacts, R.id.nav_childList, R.id.nav_about,
                R.id.nav_logout)
    ...
    public void stopLocationUpdates()
    {
        ...
        mViewModel.setLocationTrackingStatus(false);
    }
    ...
    protected void onResume() {
        super.onResume();
        if(Util.isAfternoon(getApplicationContext()))
        {
            setActionBarTitle(getString(R.string.afternoon_way));
        }
        else
        {
            setActionBarTitle(getString(R.string.morning_way));
        }
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                mViewModel.setPosDriver(location);
                if(mViewModel.getLocationTrackingStatus() == null ||
                        mViewModel.getLocationTrackingStatus().getValue() == null ||
                        !mViewModel.getLocationTrackingStatus().getValue())
                {
                    mViewModel.setLocationTrackingStatus(true);
                }
